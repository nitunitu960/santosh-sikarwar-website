...
def article_url(post):
    """Canonical article URL. Clean, crawlable path (one static HTML file per
    article, generated by build_articles.py). Caller must pass a slug-eligible
    post. NOTE: this must stay in sync with build_articles.py clean_url()."""
    return BASE + "samachar/" + post["slug"] + "/"
